...
import { FaBath, FaShareAlt, FaBed, FaUserCheck, FaPlus, FaMapMarkerAlt, FaVideo, FaCamera, FaUserCircle, FaHeart } from 'react-icons/fa'
    ...
    <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'}`}>
      <section id='properties' className='lg:w-[90%] m-auto lg:px-20 px-6 py-20 w-full flex flex-col justify-center items-start gap-10'>
        <div className='flex flex-col justify-center items-start gap-4'>
          ...
          <h1 data-aos="zoom-in" className='text-black text-4xl font-semibold dark:text-white'>Explore the latest <br /> properties available</h1>
        </div>
